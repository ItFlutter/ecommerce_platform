...
class CouponEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(CouponEditController());
    return Scaffold(
        appBar: AppBar(title: Text("191".tr)),
        body: GetBuilder<CouponEditController>(builder: (controller) {
                  ...
                  Center(
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          controller.expireDate != null
                              ? controller.expireDate.toString()
                              : controller.couponModel.couponExpiredate!,
